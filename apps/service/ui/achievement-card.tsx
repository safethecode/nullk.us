  ...
  return (
    ...
    >
      <div className="mb-3 flex items-start justify-between gap-3">
        ...
        {isUnlocked ? (
          <span className="flex items-center gap-1 rounded-full border border-emerald-200 bg-emerald-50 px-2 py-0.5 font-medium text-[11px] text-emerald-700">
            <Check className="h-3 w-3" />
            달성
          </span>
        ) : (
          <span className="rounded-full border border-neutral-200 bg-neutral-50 px-2 py-0.5 font-medium text-[11px] text-neutral-400">
            미달성
          </span>
        )}
      </div>
